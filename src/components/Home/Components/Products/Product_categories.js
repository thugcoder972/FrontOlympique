...
export default function Product_categories() {
    ...
    const getTotalQuantity = () => {
     ...
     const selectGallery= e=>{
      ...
      const newGallery = newArr.filter(item =>{
        if(e.target.value === "All"){return ModelProducts;}
  ...
  return (
    <Wrapper>
      ...
      <li className="m-3">
                <button onClick={selectGallery} value="All" className="btn btn-dark m-2" >All</button>
            </li>
            <li className="m-3">
                <button onClick={selectGallery} value="Tops" className="btn btn-dark m-2" >Top</button>
            </li>
            <li className="m-3">
            <button className="btn btn-dark  m-2" onClick={selectGallery} value="JumpSuit" >JumSuit</button>
            </li>
            <li className="m-3">
            <button className="btn btn-dark  m-2" onClick={selectGallery} value="JumpSuit" >Lingerie</button>
            </li>
            <li className="m-3">
            <button className="btn btn-dark  m-2" onClick={selectGallery} value="jeans" >Jeans</button>
            </li>
            <li className="m-3">
            <button className="btn btn-dark  m-2" onClick={selectGallery} value="Dresses" >Dresses</button>
            </li>
            <li className="m-3">
            <button className="btn btn-dark  m-2" onClick={selectGallery} value="Jumpers" >Jumpers</button>
            </li>
            <li className="m-3">
            <button className="btn btn-dark  m-2" onClick={selectGallery} value="JumpSuit">Leggins</button>
            </li>
        </ul>
      </div>
